...
class DeepSeekAPIProvider(OpenAIStandardProvider):
    def __init__(self):
        self.sync_client =OpenAI(api_key=os.environ.get("DEEPSEEK_API_KEY"), base_url="https://api.deepseek.com")
        self.async_client = AsyncOpenAI(api_key=os.environ.get("DEEPSEEK_API_KEY"), base_url="https://api.deepseek.com")
...
if __name__ == "__main__":
    ...
    class Response(BaseModel):
        city: str
    response = asyncio.run(DeepSeekAPIProvider().async_chat_completion_with_response_model(
        messages=messages,
