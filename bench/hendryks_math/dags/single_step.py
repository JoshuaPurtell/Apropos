...
import asyncio
from src.programs.convenience_functions.dag_constructors import build_single_step_program
...
def hendryks_math_single_step_example(model_name="gpt-3.5-turbo"):
    ...
    math_problem_dag = asyncio.run(build_single_step_program(execute, model_name=model_name, dag_input_names=["<<<MATHEMATICS_QUESTION>>>"], dag_input_aliases={
