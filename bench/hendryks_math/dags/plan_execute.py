...
import asyncio
from src.programs.convenience_functions.dag_constructors import build_path_program
...
def hendryks_math_plan_execute_example(model_names=["gpt-3.5-turbo", "gpt-3.5-turbo"]):
    ...
    math_plan_execute_path_dag = asyncio.run(build_path_program([plan, execute], model_names=model_names, dag_input_names=["<<<MATHEMATICS_QUESTION>>>"], dag_input_aliases={"question": "<<<MATHEMATICS_QUESTION>>>"},
