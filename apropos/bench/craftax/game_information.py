craftax_classic_game_rules = {
    "World Information": {
        "Actions with Requirements": {
            "Movement": {
                "left": {
                    "Requirements": "Flat ground west of the agent."
                },
                "right": {
                    "Requirements": "Flat ground east of the agent."
                },
                "up": {
                    "Requirements": "Flat ground north of the agent."
                },
                "down": {
                    "Requirements": "Flat ground south of the agent."
                }
            },
            "Basic Actions": {
                "do": {
                ...
                "noop": {
                    "Requirements": "Always applicable. (Means no operation.)"
                }
            },
            "Crafting and Building": {
                "place_stone": {
                    "Requirements": "Stone in inventory."
                },
                "place_table": {
                    "Requirements": "Wood in inventory."
                },
                "place_furnace": {
                    "Requirements": "Stone in inventory."
                },
                "place_plant": {
                    "Requirements": "Sapling in inventory."
                },
                "make_wood_pickaxe": {
...
"World Information": {
    "Actions with Requirements": {
        ...
        "Combat and Tools": {
            "shoot_arrow": {
                "Requirements": "Have bow and arrows in inventory."
            },
            "cast_fireball": {
        ...
        "Consumables": {
            "drink_potion_red": {
                "Requirements": "Have red potion in inventory."
            },
            "drink_potion_green": {
                "Requirements": "Have green potion in inventory."
            },
            "drink_potion_blue": {
                "Requirements": "Have blue potion in inventory."
            },
            "drink_potion_pink": {
                "Requirements": "Have pink potion in inventory."
            },
            "drink_potion_cyan": {
                "Requirements": "Have cyan potion in inventory."
            },
            "drink_potion_yellow": {
                "Requirements": "Have yellow potion in inventory."
            },
            "read_book": {
                "Requirements": "Have book in inventory."
            }
        },
        "Level Navigation": {
            "descend": {
