# Code originally from the 2024 Basis Prompt Olympics
# All credit to Chris Ruppelt
...
class Recorder:
    ...
    def _save(self, filename):
        ...
        filename = str(f"apropos/bench/crafter/artifacts/{filename}.mp4")
        imageio.mimsave(filename, self._frames)

    def force_save(self, filename):
        self._save(filename)
