...
from apropos.src.lms.vendors.json_structured_outputs.core import (
    ...
    extract_pydantic_model_from_response,
)
...
class DeepSeekAPIProvider(OpenAIStandardProvider):
    ...
    async def async_chat_completion_with_response_model(
        ...
        structured_api_response = await extract_pydantic_model_from_response(
    ...
    def sync_chat_completion_with_response_model(
        ...
        structured_api_response = extract_pydantic_model_from_response(
            raw_text_api_response, response_model
        )
        return structured_api_response
